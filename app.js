...
function colorizeSliders(color, hueSlider, brightSlider, saturationSlider) {
  ...
  saturationSlider.style.backgroundImage = `linear-gradient(to right, ${saturationScale(
    0
  )}, ${saturationScale(1)})`;
  brightSlider.style.backgroundImage = `linear-gradient(to right,  ${brightScale(
    0
